class Admin::MenusController < Admin::BaseController
 ...
 before_action :list_dishes, only: %i(new edit)
    ...
    def menu_params
        ...
        params.require(:menu).permit :name, dish_ids:[], menu_dishes_attributes:[:id, :menu_id, :dish_id]
    end
    def menu_params
        params.require(:menu).permit :name, :image, dish_ids:[], menu_dishes_attributes:
         [:id, :menu_id, :dish_id]
    end
    def list_dishes
